        ...
        return (
            <div className='flex items-center sm:mt-5 lg:mt-0'>
                <NavLink style={{ textDecoration: 'none' }}>
                    <span className=' text-gray-500 border-r-2 pr-3 hover:text-orange-500'>
                        {userInfo.hoTen}
                    </span>
                </NavLink>
                <NavLink onClick={handleLogout} style={{ textDecoration: 'none' }}>
                    <span className='flex items-center text-gray-500 ml-3  hover:text-orange-500'>
        ...
        return (
            <div className='flex items-center sm:mt-5 lg:mt-0'>
                <NavLink style={{ textDecoration: 'none' }} to='/login'>
                    <span className='flex items-center text-gray-500 border-r-2 pr-3 hover:text-orange-500'>
